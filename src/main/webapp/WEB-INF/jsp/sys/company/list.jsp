...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#mytable").datagrid({
			...
			//显示在前台的域
		    columns:[[
		    	{field:"checkbox",checkbox:true,width:"10px"},
		        {field:"companyid",title:"单位编号",width:"25%"},    
		        {field:"companyname",title:"单位名称",width:"25%"},
		        {field:"admindivi",title:"行政区划号码",width:"25%"},
		        {field:"comlevel",title:"单位级别",width:"25%",formatter:function(value, row, index) {
		        	if (value == 1) {
		        		return "市级";
		        	} else if (value == 2) {
		        		return "区级";
	 ...
	 $(function() {
	 	...
	 	$("#upd").click(function() {
        	...
        	var select = $("#mytable").datagrid("getSelected");
	...
	<div id="tb">
	 ...
	 <div id="dlg">
	 	...
	 	<table id="table" style="height: 100%;width: 100%">
	 		<tr>
		 		<td style="text-align:center;width: 100px">单位编号</td>
		 		<td><input id="mycompanyid" class="easyui-textbox" name="companyid" style="width:200px;" readonly="readonly"></td>
	 		</tr>
